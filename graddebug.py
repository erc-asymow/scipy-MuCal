...
#d = d.Define("globalidxdebug","isdebugidx(globalidxv) && abs(gradv)<11.898")
d = d.Define("globalidxdebug","isdebugidx(globalidxv) && abs(gradv)>1.")
...
d = d.Define("gradsum", "Sum(graddebug)")
...
hgrad = d.Histo1D(("hgrad","",400,-50.,50.), "graddebug")
hgradsum = d.Histo1D(("hgradsum","",400,-50.,50.), "gradsum")

hgradsecond = d.Histo1D(("hgradsecond","",400,-0.5,0.5), "gradsecond")
hgradfirst = d.Histo1D(("hgradfirst","",400,-50.,50.), "gradfirst")
