...
#f = "/data/bendavid/muoncaldatalarge/MuonGunGlobalCorRec_GBLchisq/200908_222922/0000/*.root"
...
#f = "/data/bendavid/cmsswdev/muonscale/CMSSW_10_6_17_patch1/work/resultsnom/*.root"
#f = "/data/bendavid/cmsswdev/muonscale/CMSSW_10_6_17_patch1/work/resultsgeant100xgen/*.root"
#f = "/data/bendavid/cmsswdev/muonscale/CMSSW_10_6_17_patch1/work/resultsgeant100xrec/*.root"
...
#f = "/data/bendavid/cmsswdev/muonscale/CMSSW_10_6_17_patch1/work/resultsgeantintrechelixprec/globalcor_*.root"
...
def scalesigma(x, etasc, ks):
    ...
    scaleout = scale(A,e,M,ks, qs, etasc[...,np.newaxis,np.newaxis])
...
for ieta,(etaL, etaH, etaC) in enumerate(zip(etasL, etasH, etasC)):
    ...
    x = pmin(fg, x, (dsetbin,etaC,ntotal), doParallel=False, jac=True, h=None,xtol=1e-14,edmtol=1e-3)
