...
Ix0 = sympy.Symbol("Ix0")
Iy0 = sympy.Symbol("Iy0")
Iz0 = sympy.Symbol("Iz0")

Jx0 = sympy.Symbol("Jx0")
Jy0 = sympy.Symbol("Jy0")
Jz0 = sympy.Symbol("Jz0")

Kx0 = sympy.Symbol("Kx0")
Ky0 = sympy.Symbol("Ky0")
Kz0 = sympy.Symbol("Kz0")

rx0 = sympy.Symbol("rx0")
ry0 = sympy.Symbol("ry0")
rz0 = sympy.Symbol("rz0")

I0 = Ix0*coords.i + Iy0*coords.j + Iz0*coords.k
J0 = Jx0*coords.i + Jy0*coords.j + Jz0*coords.k
K0 = Kx0*coords.i + Ky0*coords.j + Kz0*coords.k

r0 = rx0*coords.i + ry0*coords.j + rz0*coords.k
...
localpzsign = sympy.Symbol("localpzsign")
...
inparms = [qop0, dxdz0, dydz0, x0, y0, B]
inparmlabels = ["qop0", "dxdz0", "dydz0", "x0", "y0", "B"]
